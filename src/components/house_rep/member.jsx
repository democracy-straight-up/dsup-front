    ...
    <>
      <tr>
        ...
        <td className="align-middle">
          ...
          {member?.is_delegate ? (
            <span className="alert alert-success p-0 px-2 mx-2">House Rep</span>
          ) : null}
        </td>

        {house_repInfo?.is_active ? (
          <>
        ...
        {member?.user?.username === AuthUser.username ? (
          <td className="align-middle py-3">
            ...
            {dissolve === true ? (
              <>
                Dissolve The District Council {dissolve} ?
                <input
                  type="checkbox"
                  checked={showModal}
      ...
      <Modal show={showModal} onHide={handleCloseModal}>
        <Modal.Header className="border-0" closeButton>
          <Modal.Title>Dissolve Disctrict Council</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          This action will dissolve this Disctrict Council permanently, do you want to proceed?
        </Modal.Body>
