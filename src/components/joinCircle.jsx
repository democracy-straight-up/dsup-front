    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-sm-12 col-md-6 mt-3">
          <h1 className="text-center">Join A Circle </h1>
          <div className="">
            <h4 className="text-left">You must have an Invitation Key to join a circle.</h4>
            <p className="text-left">
              The First Delegate of a circle should send you an Invitation Key. This cannot be done
              via the website.
            </p>
            <p className="text-left">
              Or you can create your own circle and start inviting others to join it.
            </p>
            <div className="col text-center">
              <span onClick={handleCircle} className="btn btn-primary btn-sm mb-3">
                Create A Circle
              </span>
            </div>
          </div>
          ...
          <input
            ...
            placeholder="Enter the circle invitation key here"
          />
          <div className="col text-center">
